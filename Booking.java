...
public class Booking {
    ...
    // Constructor
    public Booking(Room room, LocalDateTime start_time, LocalDateTime end_time, 
                   int attendees, String manager) {
    ...
    // Cập nhật đặt phòng
    public boolean update_booking(RoomManager roomManager, 
                                  LocalDateTime new_start_time, 
                                  LocalDateTime new_end_time, 
                                  int new_attendees) {
